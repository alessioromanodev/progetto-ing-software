...
export default function CarrelloPage() {
  ...
  const [shippingMethod, setShippingMethod] =
    useState<string>("Ritiro in negozio")
  ...
  const discountedTotal = isLoggedIn
    ? Number((totale * 0.9).toFixed(2))
    : totale
          ...
          {cart.length > 0 && (
            <div className="flex items-center space-x-4">
              ...
              <Select value={shippingMethod} onValueChange={setShippingMethod}>
                ...
                <SelectContent>
                  <SelectItem value="Ritiro in negozio">
                    Ritiro in negozio
                  </SelectItem>
                  <SelectItem value="Consegna a domicilio">
            ...
            <div className="mt-6 space-y-4">
              <div className="text-right">
                <p className="text-xl font-semibold">
                  Totale senza sconto: €{totale.toFixed(2)}
                </p>
                {isLoggedIn && (
                  <p className="text-lg text-green-600">
                    Sconto per i clienti registrati - 10%: €
